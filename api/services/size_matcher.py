...
class SizeMatcherService:
    ...
    def recommend_size(
        ...
        if not user_measurements:
            ...
            return {"success": False, "message": "📐 Укажи свои параметры, чтобы получить рекомендацию по размеру", "confidence": "none", "recommended_size": None, "alternative_size": None, "details": {"reason": "no_measurements"}}
        ...
        if not size_table:
            ...
            return {"success": False, "message": "⚠️ Таблица размеров не найдена", "confidence": "none", "recommended_size": None, "alternative_size": None, "details": {"reason": "no_size_table"}}
        ...
        if not filtered_table:
            ...
            return {"success": False, "message": "⚠️ Не удалось подобрать размер. Рекомендуем уточнить у продавца", "confidence": "none", "recommended_size": None, "alternative_size": None, "details": {"reason": "no_available_sizes"}}
        ...
        if max_possible_score == 0:
            ...
            return {"success": False, "message": "⚠️ Нет общих параметров для сравнения. Заполните больше данных", "confidence": "none", "recommended_size": None, "alternative_size": None, "details": {"reason": "no_common_params"}}
        ...
        if not sorted_scores or sorted_scores[0][1]['score'] == 0:
            ...
            return {"success": False, "message": "⚠️ Не удалось подобрать размер. Рекомендуем уточнить у продавца", "confidence": "none", "recommended_size": None, "alternative_size": None, "details": {"reason": "no_match"}}
